...
#
#              for k in range(r - s):  r-s is negative
#                  count = 0            count should be initialized outside of for loop
#                  if math.cos(r) > 0:
#                      count = 1         count=count+1
#                  return count     return shouldn be on same indentation as for k
#
#     f. The code in the "graphics accumulation" example below includes:
#            for _ in range(n):
#        What does the   _   (underscore) mean? it is a variable
#
