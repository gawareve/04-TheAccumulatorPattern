...
def run_test_count_cosines_from():
    ...
    expected = 2
    answer = count_cosines_from(0, 3, .5)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)

    expected = 0
    answer = count_cosines_from(4, 6, 1)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)

    expected = 3
    answer = count_cosines_from(17, 20, 0.15)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    expected = 0
    answer = count_cosines_from(16, 18, 0.7)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    expected = 1
    answer = count_cosines_from(16, 18, 0.6)
    print('Test 1 expected:', expected)
    print('       actual:  ', answer)
    # -------------------------------------------------------------------------
    # TO DO: 6 (continued).
